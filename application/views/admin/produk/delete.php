  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center">Delete data produk</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo base_url('admin/produk/delete/'.$produk->id_produk) ?>" class="btn btn-danger"><i class="fa fa-trash-o">Ya, Hapus Data Ini</i></a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
