						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									<a href="<?php echo base_url('dasbor/konfirmasi/'.$header_transaksi->kode_transaksi) ?>" class="btn btn-secondary btn-sm"><i class="fa fa-upload"></i> <strong>Konfirmasi Bayar</strong></a>
								</div>
							</td>
						</tr>
						<?php $i++; } ?>
