			...
			<div class="wrap-table-shopping-cart bgwhite">
				...
				<table class="table-shopping-cart">
					...
					<tr class="table-row">
						...
						<td>
						    <button type="submit" name="update" class="btn btn-dark btn-sm">
						    	<i class="fa fa-edit"></i> <strong>Update</strong>
						    </button>
					...
					<tr class="table-row bg-dark" style="font-weight: bold;">
						<td colspan="4" class="column-1 text-light">Total Price</td>
					...
					<table class="table">
						<thead>
							<tr>
								...
								<th><input type="text" name="kode_transaksi" class="form-control" readonly value="<?php echo $kode_transaksi ?>" required></th>
							</tr>
							<tr>
								<th width="25%">Name</th>
						...
						<tbody>
							<tr>
								<td>Email Address</td>
								<td><input type="email" name="email" class="form-control" placeholder="Email Address" value="<?php echo $pelanggan->email ?>" required></td>
							</tr>
							<tr>
								<td>Telephone</td>
								<td><input type="text" name="telepon" class="form-control" placeholder="Telephone" value="<?php echo $pelanggan->telepon ?>" required></td>
							</tr>
							<tr>
								<td>Address</td>
							...
							<tr>
								...
								<td>
									<button class="btn btn-dark" type="submit">
										<i class="fa fa-save"></i> <strong>Check Out Now</strong>
									</button>
